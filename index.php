...
<h1 style="font-size: 30px"><img src="images/logosmall.png" alt="Safetee Logo" title="" height="50" width="50"/>Safetee</h1>
</div>
<!--End of Header Logo-->
...
<div id="" class="one_half">
	<img src="images/phone.png" height="400" width="280" alt="Safetee Screen" />
</div>
...
<h1>Safetee - keeps you safe!</h1>
<h2 class="subheader">Safetee is an android app that seeks to keep women safe and protect them from violence. </h2>
<!--End of Banner Title-->
<p>Safetee helps you quickly contact your close circle incase of emergencies with your exact location, helps you record evidence of sexual/domestic violence and provides you resources to keep you safe at all times.</p>

<!--<p class=hint">ios coming soon</p>-->
<div style="margin:0; padding:0">
	<a href="https://play.google.com/apps/testing/com.getsafetee.safetee" title="Download Safetee">
		<img src="images/playstore.png" style="height: 100px;"" />
	</a>	
</div>
...
<h5 style="margin-left: 20px;color: #666">Partners</h5>

<div class="row">

<img src="images/companies/company_logo_1.png" alt="CCHUB" style="height:50px; width: auto " width="140"/>
<img src="images/companies/company_logo_2.jpg" alt="STOPSCANN" style="height:50px; width: auto " width="114"/>
<img src="images/companies/company_logo_3.jpg" alt="Project Alert" style="height:50px; width: auto " width="137"/>
...
<h2 class="section_title"><span>Features</span></h2>
<!--End of Features Title-->

<!--Start of Features List-->
<ul>
<li class="one_half"><i class="fa fa-circle fa-4x icon-4x"></i>
<h4>Circle of Trust</h4>
<p>Safetee helps you contact your closest friends/family during dangerous situations. </p></li>
<li class="one_half last"><i class="fa fa-volume-up fa-4x icon-4x"></i>
<h4>Secure Audio Recordings</h4>
<p>Safetee helps you record a sexual or domestic violence occuring, and saves it securely to the cloud. This can be used to effectively prosecute the offender. </p></li>
<li class="one_half"><i class="fa fa-users fa-4x icon-4x"></i>
<h4>NGOs support</h4>
<p>Safetee connects victims of sexual and domestic violence to relevant NGOs for counselling, support and prosecution of the offender. Safetee only does this when authorised by the user. </p></li>
<li class="one_half last"><i class="fa fa-dashboard fa-4x icon-4x"></i>
<h4>NGOs Dashboard</h4>
<p>Safetee helps NGOs manage incidences of sexual/domestic violence and follow such cases through to conclusion. </p></li>
...
<q>I love Safetee. For me being able to get resources to stay safe in a dangerous world is priceless.</q>
<footer>
<img style="height:60px" src="images/testimonial_author_1.jpg" height="60" width="60" alt="Bibilola"/>
<div>Bibilola</div>
...
<!--Start of Testimonial-->
<blockquote class="one_third">
<q>Safetee saved me during a bad date. I was able to call for help from my best friend using the app</q>
<footer>
<img style="height:60px" src="images/testimonial_author_2.jpg" height="60" width="60" alt="Lola Alao"/>
<div>Lola Alao</div>
</footer>
</blockquote>
<!--End of Testimonial-->
...
<q>Safetee recordings were vital in getting justice in my rape case. They provided the evidence needed to get justice. </q>
<footer>
<img style="height:60px" src="images/testimonial_author_3.jpg" height="60" width="60" alt="Anonymous"/>
<div>Anonymous</div>
...
<h2>To get updates, please subscribe...</h2>
...
<input id="submit" class="gradient" type="submit" value="Subscribe" name="submit" onclick="void()" />
</form>
</div>
<!--End of Newsletter-->
...
<p>
&copy; Safetee 2016. All rights reserved.
</p>
</div>
</footer>
